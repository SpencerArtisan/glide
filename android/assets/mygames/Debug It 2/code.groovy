...
GROUND = 210
micky = resources.createImageSprite("pogo").setPosition(80, GROUND)
stewie = resources.createImageSprite("tricycle").setPosition(1000, GROUND-26)
...
while (screen.update()) {
    ...
    if (stewie.overlaps(stewie)) {
        resources.createImageSprite("smug")
